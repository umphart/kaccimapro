...
const PaymentSummary = ({ 
  ...
  const RENEWAL_AMOUNT = 15000; // Keep at 15000
          ...
          <>
            {!isRenewal ? (
              ...
              <>
                ...
                <p className="note">
                  <strong>Note:</strong> Annual renewal fee is ₦15,000.00. Renewal must be completed by January 31st to avoid late fees.
                </p>
              </>
            )}
          </>
